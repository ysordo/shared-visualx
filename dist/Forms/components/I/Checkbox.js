 ...
 */
const Checkbox = ({ name, label, checked, styleType, className, onChange, }) => ((0, jsx_runtime_1.jsxs)("label", { htmlFor: name, className: `${styleType} ${className}`, children: [(0, jsx_runtime_1.jsx)("input", { id: name, type: "checkbox", checked: checked, onChange: () => onChange(!checked) }), label] }));
